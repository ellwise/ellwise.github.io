...
Designs and builds scalable data products, with a track record of shipping from first principles to production.
Experienced in semantic modelling, large-scale data engineering pipelines, and highly regulated industries.
...
- Research focus: Fourier-collocation methods for wave equations, high-performance scientific computing, research-to-production software development.
...
- Data and software engineer within the Data & Insights business group, serving clients who manage large-scale infrastructure across energy, rail, telecommunications, and government.
...
- Language modelling and semantic engineering work includes:
  ...
  - Building ontology authoring tooling to support knowledge graph design workflows, including an LLM-based interface for querying and editing ontologies conversationally.
- Data engineering work includes:
  - Building and maintaining data pipelines across GCP, BigQuery, Airflow, and dbt for multi-sector clients.
